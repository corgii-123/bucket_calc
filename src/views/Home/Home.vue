<template>
  <d-layout v-loading="loadingState">
    <header class="dheader">
      ...
      <div class="source-book">
        ...
        ></d-icon>
        <span style="white-space: nowrap; line-height: 10vh; margin-right: 5px"
          >参考规范材料</span
        >
        <div
          style="
        ...
        >
          <d-input
            v-model="Object.keys(sourceBook)[0]"
            size="sm"
            readonly
            @click="openReference(Object.values(sourceBook)[0])"
            class="reference-input"
          ></d-input>
          <d-input
            v-model="Object.keys(sourceBook)[1]"
            size="sm"
            readonly
            @click="openReference(Object.values(sourceBook)[1])"
            class="reference-input"
          ></d-input>
        </div>
      </div>
  ...
  <FileModal
    ...
    @update:currentWorkSpace="updateList"
  ></FileModal>
</template>
...
const sourceBook = ref({
  "Suction Installed Caisson Foundations for Offshore Wind: Design Guidelines [Offshore Wind Accelerator]":
    "2019-suction-installed-caisson-foundations-for-of.pdf",
  "Petroleum and natural gas industries-Specific requirements for offshore structures [ISO/DIS 19901-4]":
    "ISODIS-19901-4-2022.pdf",
});
